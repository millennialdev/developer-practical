        ...
        {SERVICES.map((service) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-brand-gray-500 text-[15px] leading-relaxed mt-2">
                {service.description}
              </p>
              <a
                href="#contact"
                className="inline-flex items-center gap-1.5 text-brand-red font-medium text-sm mt-4 hover:gap-3 transition-all duration-300"
              >
